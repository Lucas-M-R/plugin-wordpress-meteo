...
{
    return meteo_regular($city);
}
add_shortcode('meteo', 'shortcode_meteo');


function meteo_regular($city)
{
    global $wpdb;
    ...
    if (is_null($result) === false) {
        ...
        echo 'Le vent souffle à ' . $weather['wind_speed'] . 'km/h<br/>';
...
function shortcode_meteo_mini($city)
{
    ...
    return getmeteomini($city);
}
add_shortcode('meteomini', 'shortcode_meteo_mini');


function getmeteomini($city)
{
    global $wpdb;
    $a = shortcode_atts(array(
        'ville' => 'Lons-le-Saunier'
...
<style>
    ...
    .temp16,
    .temp15 {
        background-color: #B6EC78;
    }

    .temp14,
    .temp13 {
        background-color: #92CD76;
    }

    .temp12,
    .temp11 {
        background-color: #6EB474;
    }

    .temp10,
    .temp9 {
        background-color: #4A9872;
    }
    ...
    .temp-20,
    .temp-21 {
        background-color: #9C56E1;
    }

    .temp-22,
    .temp-23 {
        background-color: #B356E2;
    }
